...
namespace PhoneApp1
{
    public partial class Lobby : PhoneApplicationPage
    {
        ...
        void client_GatAvailablePlayLobbiesCompleted(object sender, ServiceReference1.GatAvailablePlayLobbiesCompletedEventArgs e)
        {
            Data.Clear();
        ...
        private void LobbyList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                ...
                App.Host = new ServiceReference1.Player() { PlayerId = data.PlayerId, PlayerName = data.PlayerName };
