...
namespace LobbyService.Web.DTO.MonopolyEngine
{
    public class GameFunctions
    {
        ...
        {
            if (gPlayer.MyState.Ownership[PropID] == gPlayer.OrderNumber)
            {
        ...
        public static void LeaveGame(GamePlayer gPlayer)
        {
            ...
            ChangeActivePlayer(gPlayer.MyState);
        }
    ...
    //standaard randomisatie algoritme lijsten
