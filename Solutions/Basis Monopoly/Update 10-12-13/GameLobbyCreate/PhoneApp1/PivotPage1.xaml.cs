            ...
            try
            {
                ...
                foreach (var item in localData)
                {
                    ...
                    if (item.Position == location)
                    {
                        ...
                        PosData.Add(new PositionData() { Name = item.Name, Cost = item.BuyCost, Group = item.Group.ToString(), HouseCost = item.HouseCost.ToString(), Rent0 = item.Rent0, Rent1 = item.Rent1, Rent2 = item.Rent2, Rent3 = item.Rent3, Rent4 = item.Rent4, Rent5 = item.Rent5, Owner = temp });
                    ...
                    if (e.Result.IsBought[item.ID])
                    {
                        ...
                        {
                            PropData.Add(new PositionData() { Cost = item.BuyCost, Group = item.Group.ToString(), HouseCost = item.HouseCost.ToString(), Name = item.Name, Rent0 = item.Rent0, Rent1 = item.Rent1, Rent2 = item.Rent2, Rent3 = item.Rent3, Rent4 = item.Rent4, Rent5 = item.Rent5, Morguage = Morguage, HouseLevel = HouseLevel, SetLevel = SetLevel });
                        }
                    }
                }
                if (!test)
